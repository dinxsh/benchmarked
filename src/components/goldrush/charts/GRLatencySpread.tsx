    ...
    <div>
      <div style={{ marginBottom: 12, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        {bestJitter && (
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 10, color: C.textMuted, fontFamily: GR_FONTS.mono, letterSpacing: '0.08em' }}>
              BEST JITTER
            </div>
            <div style={{ fontSize: 12, color: C.green, fontWeight: 700, fontFamily: GR_FONTS.mono }}>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={data} margin={{ top: 4, right: 20, left: 0, bottom: 4 }}>
          ...
          <Bar dataKey="p99ext" stackId="s" name="P99 ext" fill={C.red} fillOpacity={0.4} isAnimationActive radius={[2, 2, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
