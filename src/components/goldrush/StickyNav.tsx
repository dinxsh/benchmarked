  ...
  return (
    <div style={{
      ...
      <span style={{ display: 'flex', alignItems: 'center', gap: 5, flexShrink: 0 }}>
        ...
        <span style={{ fontSize: 11, color: C.green, fontFamily: GR_FONTS.mono, fontWeight: 700 }}>LIVE</span>
      </span>

      {leader && (
        <span style={{ fontSize: 11, color: C.textSecondary, fontFamily: GR_FONTS.mono, flexShrink: 0 }}>
      ...
      <button
        ...
        style={{
          ...
          color: C.textSecondary, fontSize: 11, fontFamily: GR_FONTS.ui,
